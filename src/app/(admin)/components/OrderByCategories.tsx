...
import { useGetOrderPerCategories } from "../_hooks/statistics-hook";
...
export default function OrdersByCategoryChart() {
  const { data, isPending, error } = useGetOrderPerCategories();
  ...
  return (
    <Card className="w-[600px]">
      <CardHeader>
        <CardTitle className="text-sm md:text-base">Number of Orders by Category</CardTitle>
      </CardHeader>
      <CardContent>
        <ChartContainer
          config={{
